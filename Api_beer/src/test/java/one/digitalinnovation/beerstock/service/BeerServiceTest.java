...
public class BeerServiceTest {
    ...
    // @Test
    // void whenBeerInformedThenItShouldBeCreated() throws
    ...
    // @Test
    // void whenExclusionIsCalledWithValidIdThenABeerShouldBeDeleted() throws
    // BeerNotFoundException{
    // // given
    // BeerDTO expectedDeletedBeerDTO =
    // BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    // @Test
    // void whenIncrementIsCalledThenIncrementBeerStock() throws
    ...
    // int expectedQuantityAfterIncrement = expectedBeerDTO.getQuantity() +
    // quantityToIncrement;

    // // then
    // BeerDTO incrementedBeerDTO = beerService.increment(expectedBeerDTO.getId(),
    // quantityToIncrement);
    ...
    //
    // @Test
    // void whenDecrementIsCalledThenDecrementBeerStock() throws
    // BeerNotFoundException, BeerStockExceededException {
    // BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    // Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    //
    ...
    // int expectedQuantityAfterDecrement = expectedBeerDTO.getQuantity() -
    // quantityToDecrement;
    // BeerDTO incrementedBeerDTO = beerService.decrement(expectedBeerDTO.getId(),
    // quantityToDecrement);
    //
    // assertThat(expectedQuantityAfterDecrement,
    // equalTo(incrementedBeerDTO.getQuantity()));
    // assertThat(expectedQuantityAfterDecrement, greaterThan(0));
    // }
    //
    // @Test
    // void whenDecrementIsCalledToEmptyStockThenEmptyBeerStock() throws
    // BeerNotFoundException, BeerStockExceededException {
    // BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    // Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    //
